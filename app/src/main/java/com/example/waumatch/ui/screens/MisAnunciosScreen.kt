...
fun MisAnunciosScreen(navController: NavController) {
    ...
    anuncioBorrar?.let { idAnuncio ->
        AlertDialog(
            onDismissRequest = { anuncioBorrar = null },
            title = { Text("¿Eliminar anuncio?") },
            text = { Text("¿Estás seguro de que quieres eliminar este anuncio? Esta acción no se puede deshacer.") },
            confirmButton = {
                TextButton(
                    onClick = {
                        viewModel.eliminarAnuncio(idAnuncio, context)
                        anuncioBorrar = null
                    }
                ) {
            ...
            dismissButton = {
                TextButton(onClick = { anuncioBorrar = null }) {
                    Text("Cancelar")
                }
            }
        )
                ...
                LazyVerticalGrid(
                    ...
                    items(misAnuncios) { anuncio ->
                        Box(modifier = Modifier) {
                            ...
                            IconButton(
                                onClick = { anuncioBorrar = anuncio.id },
                                modifier = Modifier
